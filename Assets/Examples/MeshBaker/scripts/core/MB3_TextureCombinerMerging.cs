...
namespace DigitalOpus.MB.Core
{
    public class MB3_TextureCombinerMerging
    {
        ...
        */
        ...
        /*
        public static Rect BuildTransformMeshUV2AtlasRect(bool considerMeshUVs, 
                                            Rect _atlasRect, //this is uvRect in combined Atlas
                                            Rect _obUVRect, 
                                            Rect _sourceMaterialTiling, 
                                            Rect _encapsulatingRect)
                ...
                for (int j = i + 1; j < distinctMaterialTextures.Count; j++)
                {
                    ...
                    if (tx1.AllTexturesAreSameForMerge(tx2, _considerNonTextureProperties, resultMaterialTextureBlender))
                    {
                        ...
                        if (idxOfFirstNotNull != -1)
                        {
                            ...
                            {
                                encapsulatingRect1 = MB3_UVTransformUtility.GetEncapsulatingRectShifted(ref encapsulatingRect1, ref tx1.matsAndGOs.mats[matIdx].samplingRectMatAndUVTiling);
                            }
                            //same for tx2
                            ...
                            {
                                encapsulatingRect2 = MB3_UVTransformUtility.GetEncapsulatingRectShifted(ref encapsulatingRect2, ref tx2.matsAndGOs.mats[matIdx].samplingRectMatAndUVTiling);
                            }
                        ...
                        if (accumulatedAreaCombined < accumulatedAreaNotCombined)
                        {
                            ...
                            //the rect for material tiling combined stored on a per material  basis
